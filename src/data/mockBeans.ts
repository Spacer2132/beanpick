...
export const mockBeans: BeanProduct[] = [
  ...
  {
    id: 'libre-colombia-sidra',
    roasterName: '커피리브레',
    productName: 'Colombia El Paraiso Sidra',
    ...
    productUrl: 'https://beanpick.local/mock/libre-colombia-sidra',
  ...
  {
    id: 'anthracite-el-salvador-pacamara',
    roasterName: '앤트러사이트 커피',
    productName: 'El Salvador Santa Rosa Pacamara',
    ...
    productUrl: 'https://beanpick.local/mock/anthracite-el-salvador-pacamara',
